    ...
    public static class UserAlgorithms
    {
        ...
        public static void UpdatePlayer(GameObject obj)
        {
            ...
            if (Input.GetKeyDown(KeyCode.E) && !cupboardInteractionRequested)
                Debug.Log("[Version_3] Player vertical input: up (E).");

            if (Input.GetKeyDown(KeyCode.Q))
                Debug.Log("[Version_3] Player vertical input: down (Q).");
        ...
        public static bool IsTrumpetHovered()
        {
            ...
            Debug.Log("[Version_3] Trumpet input (T). Hit=" + GetLookedAtObjectName() + ", targetMatched=" + isLooking + ".");
            return isLooking;
        }
        ...
        public static void PlayTrumpet(GameObject obj)
        {
            ...
            VReqDV.StateAccessor.SetState("Trumpet", "played", obj, "Version_3");
            Debug.Log("[Version_3] Trumpet played. Audio=" + audioPlayed + ", state=played.");
        }
        ...
        public static bool IsBookGrabbed(GameObject obj)
        {
            ...
            Debug.Log("[Version_3] Book input (F). Target=" + (obj != null ? obj.name : "null") + ", hit=" + GetLookedAtObjectName() + ", targetMatched=" + isLooking + ".");
            return isLooking;
        }
        ...
        public static void CollectBook(GameObject obj)
        {
            ...
            VReqDV.StateAccessor.SetState("book_brown", "destroyed", obj, "Version_3");
            Debug.Log("[Version_3] Book collected: " + obj.name + ". Audio=" + audioPlayed + ", state=destroyed.");
        ...
        public static void OpenChest(GameObject obj)
        {
            ...
            bool audioPlayed = PlayAttachedAudio(obj);
            VReqDV.StateAccessor.SetState("Chest", "open", obj, "Version_3");
            Debug.Log("[Version_3] Chest opened. AnimatorTriggered=" + (a != null) + ", Audio=" + audioPlayed + ", state=open.");
        }
        ...
        public static bool IsCupboardInteracted(GameObject obj)
        {
            ...
            bool isLooking = IsPlayerLookingAt(obj);
            Debug.Log("[Version_3] Cupboard input (E). Hit=" + GetLookedAtObjectName() + ", targetMatched=" + isLooking + ".");
            return isLooking;
        }
        ...
        public static void ToggleCupboard(GameObject obj)
        {
            ...
            if (cupboard == null)
            {
                Debug.LogWarning("[Version_3] Cupboard toggle skipped. Door transforms could not be resolved for " + obj.name + ".");
                return;
            }

            bool shouldOpen = VReqDV.StateAccessor.IsState("Cupboard", "closed", obj, "Version_3");
            cupboard.TargetAngle = shouldOpen ? CupboardOpenAngle : 0f;
            bool audioPlayed = PlayAttachedAudio(obj);

            if (shouldOpen)
                VReqDV.StateAccessor.SetState("Cupboard", "open", obj, "Version_3");
            else
                VReqDV.StateAccessor.SetState("Cupboard", "closed", obj, "Version_3");

            Debug.Log("[Version_3] Cupboard toggled. Audio=" + audioPlayed + ", state=" + (shouldOpen ? "open" : "closed") + ", targetAngle=" + cupboard.TargetAngle + ".");
        }
        ...
        public static bool IsStatueGrabbed(GameObject obj)
        {
            ...
            bool isLooking = IsPlayerLookingAt(obj);
            Debug.Log("[Version_3] Statue input (R down). Hit=" + GetLookedAtObjectName() + ", targetMatched=" + isLooking + ".");
            return isLooking;
        }
        ...
        {
            VReqDV.StateAccessor.SetState("LionStatue", "rotating", obj, "Version_3");
            Debug.Log("[Version_3] Statue rotation started. state=rotating.");
        }
        ...
        {
            VReqDV.StateAccessor.SetState("LionStatue", "idle", obj, "Version_3");
            Debug.Log("[Version_3] Statue rotation stopped. state=idle.");
        }
        ...
        private static CupboardAnimationState GetOrCreateCupboardState(GameObject obj)
        {
            ...
            bool isOpen = VReqDV.StateAccessor.IsState("Cupboard", "open", obj, "Version_3");
        ...
        private static bool PlayAttachedAudio(GameObject obj)
        {
            ...
            {
                Debug.LogWarning("[Version_3] No attached audio clip found for " + (obj != null ? obj.name : "null") + ".");
                return false;
            }
